	...
	<body>
		...
		<div id="header">
			<div class="info-inside">
				...
				<h2>Морской транспорт</h2 >
			</div>
		</div>
		
		<div class="col-flex">
			<div class="first">
				<img class="animation" src="img/object6.png">
				<p>
		...
		<div class="black-t enter" style="text-align:center;">
		Морской транспорт: (в этом разделе направлен больше на получение входящего интереса и информирование клиента. Т.е. заказать тут ничего нельзя, можно только почитать и запросить консультацию)
		Линк - см. страницы 6-9. Там есть все тексты и описание. Если нужны исходники, пишите, скину
		</div>
