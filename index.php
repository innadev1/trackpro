<html>
	...
	<body>
		...
		Grindex (с 2011 года)
		Сотрудники компании TomWare обеспечивают стабильную работу системы TrackPro и дают нам оперативную и архивную информацию, которая позволяет нам, существенно улучшить работу транспортного отдела. Мы можем с уверенность сказать, что использование системы TrackPro позволило нам сократить как и временные так и материальные ресурсы.

		Rigas Satiksme (с 2011 года)
		Компания TomWare смогла не только предоставить нам решение по мониторингу соответствующее всем нашим нуждам и потребностям, но и оказывает сервис высшего качества, оперативно реагируя на любые наши запросы. Это надежный партнер, с которым удобно и приятно работать.

		Amber Distribution latvia (с 2011 года)
		Система мониторинга TrackPro позволила нам значительно упростить управление автопарком. Все операции связанные с транспортом теперь стали более прозрачными 
